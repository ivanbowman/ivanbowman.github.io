...
agentDL='https://agents.tacticalrmm.com/api/v2/agents/?version=2.8.0&arch=amd64&token=f4632552-8438-45c6-a53e-8c5f781313da&plat=linux&api=api.interalliance.org'
...
token='e0252d9722bd759d0357adc65944abb705e778d0ab8820793d51f09779ea1d7f'
clientID='1'
siteID='1'
agentType='server'
proxy=''
